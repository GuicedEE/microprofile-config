 ...
 * so that {@code @ConfigProperty} (which is meta-annotated with {@code @Qualifier})
 * is recognized by Guice as a valid binding annotation.
 */
public class ConfigPropertyBindingAnnotationProvider implements BindingAnnotationProvider
{
    @Override
